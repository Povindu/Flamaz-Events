...
export default function contatcUs() {
  return (
    <div>
      <NavbarSimple />
      <div
        className="flex flex-col lg:flex-row mt-8 justify-center items-center"
      >
        <div className="lg:w-[50%]">
          <img src={logo} alt="logo" className="w-[60%] m-auto p-8 lg:p-20" />
        </div>
        <div className="lg:w-[50%] p-20">
          ...
          <div className="p-4 lg:p-10 mt-20 mb-8">
            <p className="mb-8 text-2xl text-amber-500">Get in touch</p>
            <div className="flex flex-col lg:flex-row">
              <div className="mb-8 lg:mb-0 w-[50%]">
          ...
          <div className="p-4 lg:p-10">
            <p className="text-xl mb-4 text-amber-500">
